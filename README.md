...
<p align="center">
  <img src="docs/images/theme-preview.png" alt="LuminaPlusForPTer 综合预览" width="90%">
</p>
...
```text
/komari/data/theme/LuminaPlusForPTer/dist/assets
```
...
2. 登录 VPS，将备份视频复制到主题资源目录：
   ...
   ```bash
   ssh root@VPS_IP
   cp -f /komari/my-background.mp4 /komari/data/theme/LuminaPlusForPTer/dist/assets/my-background.mp4
   chmod 644 /komari/data/theme/LuminaPlusForPTer/dist/assets/my-background.mp4
   ```
...
<a href="https://www.star-history.com/?repos=MrGlaucus%2FLuminaPlusForPTer&type=timeline&legend=bottom-right">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=MrGlaucus/LuminaPlusForPTer&type=timeline&theme=dark&legend=bottom-right" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=MrGlaucus/LuminaPlusForPTer&type=timeline&legend=bottom-right" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=MrGlaucus/LuminaPlusForPTer&type=timeline&legend=bottom-right" />
 </picture>
</a>
