...
export function normalizeThemeSettings(
  ...
  return {
    ...
    showTodayTrafficRating: enabledUnlessFalse(settings?.showTodayTrafficRating),
    ...
    todayTrafficRatingLabels: normalizePlainText(settings?.todayTrafficRatingLabels),
